...
#### Customer Data Mart: Segmentação de Clientes (RFM & LTV)

Pipeline analítico de ponta a ponta em SQL para segmentar clientes de e-commerce. CTEs, Window Functions e regras de negócio resolvidas no banco, com o resultado entregue em um dashboard de Power BI que aponta quem está em risco de churn e qual produto oferecer.

`SQL` `Modelagem de Dados` `Power BI` `DAX` — *repositório em publicação*

#### Data Lake Serverless na AWS
...
`Python` `SQL` `AWS Lambda` `S3` `Glue` `Athena` — *repositório em publicação*
